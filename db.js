var articles = [
    ...
    },
    {
      ...
      desc:               'Seattle Happy Hour App is a mobile and desktop ready application to help people find happy hour specials in Seattle. Using the Yelp and Google API the user can search by; term, neighborhood, and more. The site uses the user’s location and search criteria to find the closest restaurant that has happy hour. By using different JS libraries the site was designed so that the user would be able to see the times of the happy hour and the locations that have happy hours going on currently.'
    },
    {
      id:                 'whalephants',
